...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002055252514"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002055252514"))
...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://gangstertown3dbeat:kT7hdFVbumnrVHsZ@lkdfilesharing01.swznwco.mongodb.net/?retryWrites=true&w=majority&appName=LKDFILESHARING01")
#your database name
...
SHORTLINK_API_URL = os.environ.get("SHORTLINK_API_URL", "mdiskshortner.link")
# SHORTLINK_API_KEY = os.environ.get("SHORTLINK_API_KEY", "ead08e1329dbc1f5a2bd4dfe9e7c6e09b2c763bc")
...
U_S_E_P = True if (True if mdiskshortner.link('U_S_E_P', "FALSE") == "TRUE" else False) and (USE_SHORTLINK) else False
